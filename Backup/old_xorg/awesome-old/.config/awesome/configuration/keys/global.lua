...
local globalKeys =
 ...
 awful.key(
    ...
    'd',
    function()
        -- Get the selected tag on current screen
        local t = awful.screen.focused().selected_tag
        -- In my setups the name of the tags are the numbers 1-9 so
        if t.name == '1' then
        awful.spawn(apps.default.terminal)
        elseif t.name == '2' then
        awful.spawn(apps.default.forTwo)
        elseif t.name=='3' then
        awful.spawn(apps.default.fm)
        elseif t.name == '4' then
        awful.spawn(apps.default.editor)
        elseif t.name=='5' then
        awful.spawn(apps.default.ide)
        elseif t.name=='6' then
        awful.spawn(apps.default.dis)
        elseif t.name=='7' then
        awful.spawn(apps.default.spot)
        elseif t.name=='8' then
        awful.spawn(apps.default.notes)
        elseif t.name=='9' then
        awful.spawn()
      end
    end,
    {description = "Open Default App for tag you're in", group = "launcher"}
  ),
  ...
  awful.key(
    ...
    { description = "Open Joplin", group = "launcher"}),
