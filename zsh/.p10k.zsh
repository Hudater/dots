# Generated by Powerlevel10k configuration wizard on 2020-10-08 at 20:49 IST.
# Based on romkatv/powerlevel10k/config/p10k-classic.zsh, checksum 59712.
# Wizard options: nerdfont-complete + powerline, small icons, classic, unicode, dark,
# round separators, slanted heads, slanted tails, 2 lines, dotted, full frame, sparse,
# many icons, fluent, transient_prompt, instant_prompt=off.
